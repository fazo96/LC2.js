...
Assembler.prototype.setLabel = function (label) {
  ...
  if (this.debug) console.log('Setting Label:', label, 'using', value, this.orig, 'to', this.symbolTable[label])
}
...
Assembler.prototype.firstPass = function (x, i) {
  ...
  if (obj.label !== undefined) this.setLabel(obj.label)
