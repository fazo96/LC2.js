...
Assembler.prototype.setLabel = function (label, value) {
  this.symbolTable[label] = value + this.orig - this.page - 1
  if (this.debug) console.log('Setting Label:', label, 'using', value, this.orig, this.page, 'to', this.symbolTable[label])
}
...
Assembler.prototype.firstPass = function (x, i) {
  ...
  if (obj.label !== undefined) this.setLabel(obj.label, i)
